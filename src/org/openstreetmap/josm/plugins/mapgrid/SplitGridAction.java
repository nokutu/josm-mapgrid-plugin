...
public class SplitGridAction extends JosmAction {
  ...
  public SplitGridAction() {
    super(
            ...
            tr("Split selected grid"),
            Shortcut.registerShortcut("MapGrid Split", tr("Split selected grid"), KeyEvent.VK_UNDERSCORE, Shortcut.SHIFT),
            false,
            "createGrid",
            false
    );
  ...
  public void setLayer(MapGridLayer layer) {
    this.layer = layer;
  }
