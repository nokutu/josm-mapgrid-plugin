...
/**
 * This is the main class of the MapGrid plugin.
 *
 * @author nokutu
 */
public class MapGridPlugin extends Plugin {
	...
	protected JMenu markGridMenu;
	protected MarkAsTodoAction markAsTodoAction;
	protected MarkAsDoingAction markAsDoingAction;
	protected MarkAsDoneAction markAsDoneAction;
	protected JMenuItem markAsTodoMenu;
	protected JMenuItem markAsDoingMenu;
	protected JMenuItem markAsDoneMenu;
	...
	public MapGridPlugin(PluginInformation info) {
		...
		this.markGridMenu = new JMenu("Mark grid as");
		Main.main.menu.viewMenu.add(this.markGridMenu);
		this.markAsTodoAction = new MarkAsTodoAction();
		this.markAsTodoMenu = MainMenu.add(this.markGridMenu, this.markAsTodoAction);
		this.markAsDoingAction = new MarkAsDoingAction();
		this.markAsDoingMenu = MainMenu.add(this.markGridMenu, this.markAsDoingAction);
		this.markAsDoneAction = new MarkAsDoneAction();
		this.markAsDoneMenu = MainMenu.add(this.markGridMenu, this.markAsDoneAction);
